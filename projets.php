...
<ul class="container  mt-5 pt-5 d-flex flex-wrap gap-3 align-items-center ">
    <li class="me-3 d-flex align-items-center">
        <span class="mdi mdi-filter text-success fs-3 me-2"></span>
    </li>
    <li class="me-3">
        <a href="projets.php" class="btn butn btn-lg butn btn-primary">Tout</a>
    </li>
    <li class="me-3">
        <a href="projets.php?categorie=infographie" class="btn btn-primary btn-lg">
            <span class="mdi mdi-gradient-horizontal me-2"></span>infographie
        </a>
    </li>
    <li class="me-3">
        <a href="projets.php?categorie=3d" class="btn btn-lg btn-primary butn">
            <span class="mdi mdi-cube-scan me-2"></span>Dispositif Interactif 3D
        </a>
    </li>
    <li class="me-3">
        <a href="projets.php?categorie=Communication numérique" class="btn btn-lg butn btn-primary">
            <span class="mdi mdi-film me-2"></span>Communication numérique
        </a>
    </li>
    <li class="me-3">
        <a href="projets.php?categorie=web" class="btn btn-lg butn btn-primary">
